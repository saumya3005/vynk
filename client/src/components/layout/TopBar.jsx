        ...
        {!isSearchOpen ? (
          ...
          >
            ...
            <div className="flex items-center gap-4 text-vynk-text">
              <button onClick={() => setIsSearchOpen(true)} className="hover:text-vynk-primary transition-colors">
                <Search size={22} />
              </button>
              <Link to="/notifications" className="hover:text-vynk-primary transition-colors">
                <Bell size={22} />
              </Link>
            </div>
          </motion.div>
          ...
          >
            ...
            <button onClick={() => setIsSearchOpen(false)} className="p-2 text-vynk-muted hover:text-vynk-text transition-colors shrink-0">
              <X size={24} />
            </button>
          </motion.div>
        )}
